...
class SchedulerManager:
    ...
    def start(self) -> None:
        ...
        schedule.every().day.at("00:01", self.tz_str).do(self._run_job, maintenance.nightly_baseline_reset)
        schedule.every(1).hours.at(":35").do(self._run_job, maintenance.hourly_snapshots)
