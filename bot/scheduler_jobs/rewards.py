...
def send_weekend_vip_message(bot) -> None:
    ...
    message_templates = [
        ...
        "{name} جان، از اینکه همراه ویژه ما هستی بی‌نهایت خوشحالیم. آخر هفته خوبی داشته باشی! 😊 نظر شما برای ما اولویت داره، پس اگه پیشنهاد یا انتقادی داشتی، باعث افتخاره که بشنویم و اعمال کنیم."
    ]
